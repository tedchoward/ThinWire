...
//TODO: Long term, the tree should be rendered in the first column of a GridBox, thus merging
//the two.  It makes sense since a tree/grid would be quite useful.
    ...
    */
    ...
    keyPressNotify: function(keyPressCombo) {        
        switch (keyPressCombo) {
            ...
            default: return this.$.keyPressNotify.apply(this, [keyPressCombo]);
        }
