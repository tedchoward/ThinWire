...
public final class Image extends AbstractComponent implements ImageComponent, ActionEventComponent {
	...
	static void updateImageDetail(Detail detail, String image) {        
		try {			            
            ...
            if (is != null) {
                ...
                detail.width = ii.getWidth();
                detail.height = ii.getHeight();
            } else {
                detail.width = -1;
                detail.height = -1;               
            }
	...
	public String toString() {
	    return Image.class.getName() + "{fileName: " + imageDetail.image + 
	    	", imageHeight: " + imageDetail.height + ", imageWidth: " + imageDetail.width + "}";
	}
}
