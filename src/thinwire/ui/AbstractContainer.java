...
abstract class AbstractContainer<T extends Component> extends AbstractComponent implements Container<T> {
    private class ChildList extends AbstractList<T> {
        ...
        public void add(int index, T o) {
            ...
            if (!(AbstractContainer.this instanceof TabFolder) && o instanceof TabSheet) throw new IllegalArgumentException("cannot add a TabSheet to a container that is not a TabFolder");
            l.add(index, o);
            processAdd(o);
